...
public class EmailNotificationService {
	...
	private final String registrationMsg = "Please verify your email by clicking the link below:\n";
	private final String resetMsg = "Please reset your password by clicking the link below:\n";
	private final String registrationEndpoint = "/api/auth/verify-email?token=";
